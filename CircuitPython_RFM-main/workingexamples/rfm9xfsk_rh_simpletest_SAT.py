...
can_send = True
operationMode = 21 #beacon with no picture mode
hasPicture = False
while True:
...
#                 rfm9xfsk.send(message)
            ...
            ax25_message = encode_ax25_frame(message, 'K4KDJ', 'K4KDJ', operationMode)
#             print(len(ax25_message))         
        ...
        decodeValue, fcsCorrect = decode_ax25_frame(packet)
        if decodeValue == 25:
            if hasPicture:
                operationMode = 26
            else:
